<%@ WebHandler Language="C#" Class="FashMidImHandler" %>
...
public class FashMidImHandler : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        ProductImageService.serProdctImage fashionmidpic = new ProductImageService.serProdctImage();
        DataSet dataset = fashionmidpic.ProductImage_GetFashMidImHandler(categoryname);
