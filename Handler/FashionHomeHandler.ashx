<%@ WebHandler Language="C#" Class="FashionHomeHandler" %>
...
public class FashionHomeHandler : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        ProductImageService.serProdctImage fashionimageone = new ProductImageService.serProdctImage();
        DataSet dataset = fashionimageone.ProductImage_GetFashImgOneForHandler(categoryname);
