<%@ WebHandler Language="C#" Class="FashImg2Handler" %>
...
public class FashImg2Handler : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        DataSet dataset = fashionimageone.ProductImage_GetFashImgtwoForHandler(categoryname);
