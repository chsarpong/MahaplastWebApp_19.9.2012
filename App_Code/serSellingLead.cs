...
/// <summary>
/// Summary description for serSellingLead
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class serSellingLead : System.Web.Services.WebService {

    public serSellingLead () {
    ...
    [WebMethod]
    public bool UpdateSellingLead(DataSet dataSet)
    {
        ...
        try
        {
            ...
            // 2. Configure the SqlCommand to be executed
            sqlCommandSelect.CommandText = "SellingLead_GetAll";
            ...
            sqlCommandInsert.CommandText = "SellingLead_Insert";
            sqlCommandInsert.CommandType = CommandType.StoredProcedure;

            // 3.3 Add second insert parameter
            SqlParameter paramInsert_0 = sqlCommandInsert.Parameters.Add("@sellingleadId", SqlDbType.Int);
            paramInsert_0.SourceColumn = "sellingleadId";
            paramInsert_0.SourceVersion = DataRowVersion.Current;


            SqlParameter paramInsert_1 = sqlCommandInsert.Parameters.Add("@sellinglead", SqlDbType.VarChar);
            paramInsert_1.SourceColumn = "sellinglead";
            ...
            sqlCommandUpdate.CommandText = "SellingLead_Update";
            sqlCommandUpdate.CommandType = CommandType.StoredProcedure;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_0 = sqlCommandUpdate.Parameters.Add("@sellingleadId", SqlDbType.Int);
            paramUpdate_0.SourceColumn = "sellingleadId";
            paramUpdate_0.SourceVersion = DataRowVersion.Current;


            // 4.2 Add first update parameter
            SqlParameter paramUpdate_1 = sqlCommandUpdate.Parameters.Add("@sellinglead", SqlDbType.VarChar);
            paramUpdate_1.SourceColumn = "sellinglead";
            ...
            sqlCommandDelete.CommandText = "SellingLead_Delete";
            sqlCommandDelete.CommandType = CommandType.StoredProcedure;

            // 5.2 Add first delete parameter
            SqlParameter paramDelete_1 = sqlCommandDelete.Parameters.Add("@sellingleadId ", SqlDbType.Int);
            paramDelete_1.SourceColumn = "sellingleadId";
