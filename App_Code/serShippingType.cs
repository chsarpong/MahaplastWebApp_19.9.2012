...
/// <summary>
/// Summary description for serShippingTypeStatus
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class serShippingType : System.Web.Services.WebService {

    public serShippingType () {
    ...
    public string HelloWorld() {
     ...
     [WebMethod]
    public DataSet ShippingType_GetProductShippingDetail(int productid)
    {
        // 1. Create an SqlCommand object
        SqlCommand sqlCommand = new SqlCommand();

        // 2. Configure the SqlCommand to be executed
        sqlCommand.CommandText = "ShippingType_GetProductShippingDetail";
    ...
    [WebMethod]
    public DataSet ShippingType_CreateShippingtypeId()
    {
        // 1. Create an SqlCommand object
        SqlCommand sqlCommand = new SqlCommand();

        // 2. Configure the SqlCommand to be executed
        sqlCommand.CommandText = "ShippingType_CreateShippingtypeId";
        sqlCommand.CommandType = CommandType.StoredProcedure;
     ...
     [WebMethod]
    public DataSet ShippingType_GetAll()
    {
        // 1. Create an SqlCommand object
        SqlCommand sqlCommand = new SqlCommand();

        // 2. Configure the SqlCommand to be executed
        sqlCommand.CommandText = "ShippingType_GetAll";
        sqlCommand.CommandType = CommandType.StoredProcedure;
    ...
    [WebMethod]
    public bool UpdateShippingType(DataSet dataSet)
    {
        ...
        try
        {
            ...
            // 2. Configure the SqlCommand to be executed
            sqlCommandSelect.CommandText = "ShippingType_GetAll";
            ...
            sqlCommandInsert.CommandText = "ShippingType_Insert";
            sqlCommandInsert.CommandType = CommandType.StoredProcedure;

            SqlParameter paramInsert_1 = sqlCommandInsert.Parameters.Add("@shippingtypeId", SqlDbType.Int);
            paramInsert_1.SourceColumn = "shippingtypeId";
            paramInsert_1.SourceVersion = DataRowVersion.Current;

            // 3.3 Add second insert parameter
            SqlParameter paramInsert_2 = sqlCommandInsert.Parameters.Add("@productid", SqlDbType.Int);
            paramInsert_2.SourceColumn = "productid";
            paramInsert_2.SourceVersion = DataRowVersion.Current;


            // 3.3 Add second insert parameter
            SqlParameter paramInsert_3 = sqlCommandInsert.Parameters.Add("@shippingcompanyname", SqlDbType.VarChar);
            paramInsert_3.SourceColumn = "shippingcompanyname";
            paramInsert_3.SourceVersion = DataRowVersion.Current;


            // 3.3 Add second insert parameter
            SqlParameter paramInsert_4 = sqlCommandInsert.Parameters.Add("@shippingcost", SqlDbType.Int);
            paramInsert_4.SourceColumn = "shippingcost";
            paramInsert_4.SourceVersion = DataRowVersion.Current;


            // 3.3 Add second insert parameter
            SqlParameter paramInsert_55 = sqlCommandInsert.Parameters.Add("@handlingtimeindays", SqlDbType.VarChar);
            paramInsert_55.SourceColumn = "handlingtimeindays";
            paramInsert_55.SourceVersion = DataRowVersion.Current;

            // 3.3 Add second insert parameter
            SqlParameter paramInsert_77 = sqlCommandInsert.Parameters.Add("@returnpolicy", SqlDbType.VarChar);
            paramInsert_77.SourceColumn = "returnpolicy";
            paramInsert_77.SourceVersion = DataRowVersion.Current;

            // 3.3 Add second insert parameter
            SqlParameter paramInsert_5 = sqlCommandInsert.Parameters.Add("@createdon", SqlDbType.DateTime);
            paramInsert_5.SourceColumn = "createdon";
            ...
            sqlCommandUpdate.CommandText = "ShippingType_Update";
            sqlCommandUpdate.CommandType = CommandType.StoredProcedure;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_1 = sqlCommandUpdate.Parameters.Add("@shippingtypeId", SqlDbType.Int);
            paramUpdate_1.SourceColumn = "shippingtypeId";
            ...
            // 4.2 Add first update parameter
            SqlParameter paramUpdate_3 = sqlCommandUpdate.Parameters.Add("@shippingcompanyname", SqlDbType.VarChar);
            paramUpdate_3.SourceColumn = "shippingcompanyname";
            paramUpdate_3.SourceVersion = DataRowVersion.Current;


            // 4.2 Add first update parameter
            SqlParameter paramUpdate_88 = sqlCommandUpdate.Parameters.Add("@shippingcost", SqlDbType.VarChar);
            paramUpdate_88.SourceColumn = "shippingcost";
            paramUpdate_88.SourceVersion = DataRowVersion.Current;



            // 4.2 Add first update parameter
            SqlParameter paramUpdate_11 = sqlCommandUpdate.Parameters.Add("@handlingtimeindays", SqlDbType.VarChar);
            paramUpdate_11.SourceColumn = "handlingtimeindays";
            paramUpdate_11.SourceVersion = DataRowVersion.Current;


            // 4.2 Add first update parameter
            SqlParameter paramUpdate_44 = sqlCommandUpdate.Parameters.Add("@returnpolicy", SqlDbType.VarChar);
            paramUpdate_44.SourceColumn = "returnpolicy";
            ...
            sqlCommandDelete.CommandText = "ShippingType_delete";
            sqlCommandDelete.CommandType = CommandType.StoredProcedure;

            // 5.2 Add first delete parameter
            SqlParameter paramDelete_1 = sqlCommandDelete.Parameters.Add("@shippingtypeId ", SqlDbType.Int);
            paramDelete_1.SourceColumn = "shippingtypeId";
