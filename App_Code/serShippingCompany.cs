...
/// <summary>
/// Summary description for serShippingCompany
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class serShippingCompany : System.Web.Services.WebService {

    public serShippingCompany () {
    ...
    [WebMethod]
    public DataSet ShippingCompany_GetAll()
    {
        // 1. Create an SqlCommand object
        SqlCommand sqlCommand = new SqlCommand();

        // 2. Configure the SqlCommand to be executed
        sqlCommand.CommandText = "ShippingCompany_GetAll";
    ...
    [WebMethod]
    public bool UpdateShippCompany(DataSet dataSet)
    {
        ...
        try
        {
            ...
            // 2. Configure the SqlCommand to be executed
            sqlCommandSelect.CommandText = "ShippingCompany_GetAll";
            ...
            sqlCommandInsert.CommandText = "ShippingCompany_Insert";
            sqlCommandInsert.CommandType = CommandType.StoredProcedure;

            // 3.3 Add second insert parameter
            SqlParameter paramInsert_0 = sqlCommandInsert.Parameters.Add("@shippingcompanyid", SqlDbType.Int);
            paramInsert_0.SourceColumn = "shippingcompanyid";
            paramInsert_0.SourceVersion = DataRowVersion.Current;


            SqlParameter paramInsert_1 = sqlCommandInsert.Parameters.Add("@shippingcompanyname", SqlDbType.Char);
            paramInsert_1.SourceColumn = "shippingcompanyname";
            ...
            sqlCommandUpdate.CommandText = "ShippingCompany_Update";
            sqlCommandUpdate.CommandType = CommandType.StoredProcedure;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_0 = sqlCommandUpdate.Parameters.Add("@shippingcompanyid", SqlDbType.Int);
            paramUpdate_0.SourceColumn = "shippingcompanyid";
            paramUpdate_0.SourceVersion = DataRowVersion.Current;


            // 4.2 Add first update parameter
            SqlParameter paramUpdate_1 = sqlCommandUpdate.Parameters.Add("@shippingcompanyname", SqlDbType.Char);
            paramUpdate_1.SourceColumn = "shippingcompanyname";
            ...
            sqlCommandDelete.CommandText = "ShippingCompany_Delete";
            sqlCommandDelete.CommandType = CommandType.StoredProcedure;

            // 5.2 Add first delete parameter
            SqlParameter paramDelete_1 = sqlCommandDelete.Parameters.Add("@shippingcompanyid", SqlDbType.Int);
            paramDelete_1.SourceColumn = "shippingcompanyid";
