...
/// <summary>
/// Summary description for serDay
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class serDay : System.Web.Services.WebService {
    ...
    [WebMethod]
    public bool UpdateDay(DataSet dataSet)
    {
        ...
        try
        {
            ...
            // 2. Configure the SqlCommand to be executed
            sqlCommandSelect.CommandText = "Day_GetAll";
            ...
            sqlCommandInsert.CommandText = "Day_Insert";
            sqlCommandInsert.CommandType = CommandType.StoredProcedure;

            // 3.3 Add second insert parameter
            SqlParameter paramInsert_0 = sqlCommandInsert.Parameters.Add("@daycode", SqlDbType.Int);
            paramInsert_0.SourceColumn = "daycode";
            paramInsert_0.SourceVersion = DataRowVersion.Current;


            SqlParameter paramInsert_1 = sqlCommandInsert.Parameters.Add("@dob_day", SqlDbType.NChar);
            paramInsert_1.SourceColumn = "dob_day";
            ...
            sqlCommandUpdate.CommandText = "Day_Update";
            sqlCommandUpdate.CommandType = CommandType.StoredProcedure;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_0 = sqlCommandUpdate.Parameters.Add("@daycode", SqlDbType.Int);
            paramUpdate_0.SourceColumn = "daycode";
            paramUpdate_0.SourceVersion = DataRowVersion.Current;


            // 4.2 Add first update parameter
            SqlParameter paramUpdate_1 = sqlCommandUpdate.Parameters.Add("@dob_day", SqlDbType.NChar);
            paramUpdate_1.SourceColumn = "dob_day";
            ...
            sqlCommandDelete.CommandText = "Day_Delete";
            sqlCommandDelete.CommandType = CommandType.StoredProcedure;

            // 5.2 Add first delete parameter
            SqlParameter paramDelete_1 = sqlCommandDelete.Parameters.Add("@daycode ", SqlDbType.Int);
            paramDelete_1.SourceColumn = "daycode";
