...
/// <summary>
/// Summary description for serMerchantAddress
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class serMerchantAddress : System.Web.Services.WebService {

    public serMerchantAddress () {
    ...
    [WebMethod]
    public bool UpdateMerchantAddress(DataSet dataSet)
    {
        ...
        try
        {
            ...
            sqlCommandSelect.CommandText = "MerchantAddress_GetAll";
            ...
            sqlCommandInsert.CommandText = "MerchantAddress_Insert";
            ...
            // 3.3 Add second insert parameter
            SqlParameter paramInsert_7 = sqlCommandInsert.Parameters.Add("@merchantId", SqlDbType.Char);
            paramInsert_7.SourceColumn = "merchantId";
            ...
            sqlCommandUpdate.CommandText = "MerchantAddress_Update";
            ...
            paramUpdate_1.SourceColumn = "postCode";
            paramUpdate_1.SourceVersion = DataRowVersion.Current;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_4 = sqlCommandUpdate.Parameters.Add("@city", SqlDbType.Decimal);
            paramUpdate_1.SourceColumn = "city";
            paramUpdate_1.SourceVersion = DataRowVersion.Current;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_55 = sqlCommandUpdate.Parameters.Add("@state", SqlDbType.VarChar);
            paramUpdate_55.SourceColumn = "state";
            paramUpdate_55.SourceVersion = DataRowVersion.Current;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_5 = sqlCommandUpdate.Parameters.Add("@country", SqlDbType.VarChar);
            paramUpdate_5.SourceColumn = "country";
            paramUpdate_5.SourceVersion = DataRowVersion.Current;


            // 4.2 Add first update parameter
            SqlParameter paramUpdate_6 = sqlCommandUpdate.Parameters.Add("@merchantId", SqlDbType.Int);
            paramUpdate_6.SourceColumn = "merchantId";
            ...
            sqlCommandDelete.CommandText = "MerchantAddress_Delete";
