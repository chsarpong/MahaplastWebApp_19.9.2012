...
/// <summary>
/// Summary description for serGender
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class serGender : System.Web.Services.WebService {
    ...
    [WebMethod]
    public bool UpdateGender(DataSet dataSet)
    {
        ...
        try
        {
            ...
            // 2. Configure the SqlCommand to be executed
            sqlCommandSelect.CommandText = "Gender_GetAll";
            ...
            sqlCommandInsert.CommandText = "Gender_Insert";
            sqlCommandInsert.CommandType = CommandType.StoredProcedure;

            // 3.3 Add second insert parameter
            SqlParameter paramInsert_0 = sqlCommandInsert.Parameters.Add("@gendercode", SqlDbType.Int);
            paramInsert_0.SourceColumn = "gendercode";
            paramInsert_0.SourceVersion = DataRowVersion.Current;


            SqlParameter paramInsert_1 = sqlCommandInsert.Parameters.Add("@gender", SqlDbType.Char);
            paramInsert_1.SourceColumn = "gender";
            ...
            sqlCommandUpdate.CommandText = "Gender_Update";
            sqlCommandUpdate.CommandType = CommandType.StoredProcedure;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_0 = sqlCommandUpdate.Parameters.Add("@gendercode", SqlDbType.Int);
            paramUpdate_0.SourceColumn = "gendercode";
            paramUpdate_0.SourceVersion = DataRowVersion.Current;


            // 4.2 Add first update parameter
            SqlParameter paramUpdate_1 = sqlCommandUpdate.Parameters.Add("@gender", SqlDbType.Char);
            ...
            sqlCommandDelete.CommandText = "Gender_Delete";
            sqlCommandDelete.CommandType = CommandType.StoredProcedure;

            // 5.2 Add first delete parameter
            SqlParameter paramDelete_1 = sqlCommandDelete.Parameters.Add("@gendercode ", SqlDbType.Int);
            paramDelete_1.SourceColumn = "gendercode";
