...
/// <summary>
/// Summary description for serShippingStatus
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
// [System.Web.Script.Services.ScriptService]
public class serShippingStatus : System.Web.Services.WebService {

    public serShippingStatus () {
    ...
    [WebMethod]
    public bool UpdateShippingStatus(DataSet dataSet)
    {
        ...
        try
        {
            ...
            sqlCommandSelect.CommandText = "ShippingStatus_GetAll";
            ...
            sqlCommandInsert.CommandText = "ShippingStatus_Insert";
            sqlCommandInsert.CommandType = CommandType.StoredProcedure;

            SqlParameter paramInsert_1 = sqlCommandInsert.Parameters.Add("@shippingstatusId", SqlDbType.Int);
            paramInsert_1.SourceColumn = "shippingstatusId";
            paramInsert_1.SourceVersion = DataRowVersion.Current;

            // 3.3 Add second insert parameter
            SqlParameter paramInsert_2 = sqlCommandInsert.Parameters.Add("@name", SqlDbType.VarChar);
            paramInsert_2.SourceColumn = "name";
            paramInsert_2.SourceVersion = DataRowVersion.Current;


            // 3.3 Add second insert parameter
            SqlParameter paramInsert_33 = sqlCommandInsert.Parameters.Add("@description", SqlDbType.VarChar);
            paramInsert_33.SourceColumn = "description";
            paramInsert_33.SourceVersion = DataRowVersion.Current;


            // 3.3 Add second insert parameter
            SqlParameter paramInsert_3 = sqlCommandInsert.Parameters.Add("@orderId", SqlDbType.Int);
            paramInsert_3.SourceColumn = "orderId";
            ...
            paramInsert_4.SourceColumn = "createdon";
            ...
            sqlCommandUpdate.CommandText = "ShippingStatus_Update";
            sqlCommandUpdate.CommandType = CommandType.StoredProcedure;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_1 = sqlCommandUpdate.Parameters.Add("@shippingstatusId", SqlDbType.Int);
            paramUpdate_1.SourceColumn = "shippingstatusId";
            paramUpdate_1.SourceVersion = DataRowVersion.Current;


            // 4.2 Add first update parameter
            SqlParameter paramUpdate_2 = sqlCommandUpdate.Parameters.Add("@name", SqlDbType.VarChar);
            ...
            // 4.2 Add first update parameter
            SqlParameter paramUpdate_4 = sqlCommandUpdate.Parameters.Add("@orderId", SqlDbType.Int);
            paramUpdate_4.SourceColumn = "orderId";
            paramUpdate_4.SourceVersion = DataRowVersion.Current;

            // 4.2 Add first update parameter
            SqlParameter paramUpdate_5 = sqlCommandUpdate.Parameters.Add("@createdon", SqlDbType.DateTime);
            paramUpdate_5.SourceColumn = "createdon";
            ...
            sqlCommandDelete.CommandText = "ShippingStatus_Delete";
            sqlCommandDelete.CommandType = CommandType.StoredProcedure;

            // 5.2 Add first delete parameter
            SqlParameter paramDelete_1 = sqlCommandDelete.Parameters.Add("@shippingstatusId ", SqlDbType.Int);
            paramDelete_1.SourceColumn = "shippingstatusId";
